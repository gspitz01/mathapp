...
describe('FractionRoundLevel', () => {
  it('should create FractionOperatorQuestion on createQuestion()', () => {
    ...
    const op1NumLimitations = new BasicOperandLimitations(true, 0, 2, false);
    const op1DenLimitations = new BasicOperandLimitations(true, 1, 3, false);
    const op1Limitations = new FractionOperandLimitations(op1NumLimitations, op1DenLimitations);
    const op2NumLimitations = new BasicOperandLimitations(true, 0, 2, false);
    const op2DenLimitations = new BasicOperandLimitations(true, 1, 3, false);
    ...
    const round = new FractionRoundLevel('Easy whatevs', operators, questionThreshold,
      op1Limitations, op2Limitations, resultLimitations, 10);
