...
describe('SimplifyFractionRoundLevel', () => {
  it('should create SimplifyFractionOperatorQuestion on createQuestion()', () => {
    ...
    const numLimitations = new BasicOperandLimitations(true, numeratorLimit, false, false);
    const denominatorLimit = 7;
    const denLimitations = new BasicOperandLimitations(true, denominatorLimit, false, false);
    const gcfLimit = 5;
